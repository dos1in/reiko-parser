'use strict';
const UnzipNode = require('./unzip/zip-node');
const UnzipBrowser = require('./unzip/zip-browser');
...
class Reader {
  constructor(path) {
    this.path = path;
    this.unzip = typeof window === 'undefined' ? new UnzipNode(path) : new UnzipBrowser(path);
  }
